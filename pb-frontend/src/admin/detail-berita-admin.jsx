import "../css/admin/detail-berita-admin.css";
...
function DetailBeritaAdmin() {
  ...
  const UpdateBerita = async () => {
    try {
      ...
      setTimeout(() => {
        navigate("/lihat-berita-admin/" + id);
      }, 2000);
    } catch (error) {
  ...
  return (
    <div>
      <div className="utama-dba">
        <Link to={"/lihat-berita-admin/" + id}>
          <div className="kembali-dba">
            <svg
        ...
        <h1>Detail Berita</h1>
        <div
          className="gambar-detail-berita-admin"
          onClick={handleClick}
        ...
        <br></br>
        <Container>
          <div className="utama-judul-kategori-dba">
            <Form.Group
              controlId="exampleForm.ControlInput1"
              className="form-one-dba ">
...
export default DetailBeritaAdmin;
