import "../css/user/publish-berita-user.css";
...
function PublishBeritaUser() {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:8000/api/ShowBeritaUser",
          {
            method: "GET",
            headers: {
  ...
  return (
    <Layout>
      ...
      <br></br>
      <Promo />
      <div className="utama-pbu">
        <h1>Publish Berita</h1>
        <div
          className="tambah-berita-admin"
          onClick={() => navigate("/tambah-berita-user")}>
          <svg
            ...
            {filteredData.length === 0 ? (
              ...
              filteredData.map((item, index) => (
                <Col
                  ...
                  md={4}
                  lg={3}
                  className="elemen-berita-pbu"
                  onClick={() => navigate("/lihat-berita-user/" + item.id)}>
                  <img
                    src={"http://localhost:8000/storage/" + item.gambar_berita}
                    alt="Berita"
                  />

                  <div className="detail-berita-bawah-pbu">
                     <h1>{truncateByWord(item.judul_berita, 65)}</h1>
                    <div className="detail-berita-depan-pbu">
                      <div className="icon-validasi-berita-depan-pbu">
                        {item.is_approved === 0 && (
                          <>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                      ...
                      <div className="penulis-berita-depan-pbu">
                        <p>
                          {item.updated_at
...
export default PublishBeritaUser;
