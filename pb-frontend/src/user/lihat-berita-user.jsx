import "../css/user/lihat-berita-user.css";
...
function LihatBeritaUser() {
  ...
  const deleteOperation = async () => {
    try {
      ...
      setTimeout(() => {
        navigate("/publish-berita-user/" + id);
      }, 2000);
    } catch (error) {
  ...
  return (
    <Layout>
      <Promo />
      <div className="atas-lihat-berita-user">
        <Link to={(`/publish-berita-user/` + id)}>
          <div className="kembali-lbu">
            <svg
        ...
        <div className="icon-lihat-berita-user">
          {is_approved === 0 && (
            <>
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="d-flex justify-content-center judul-detail-lbu-1">
        <h1 className="judul-detail-lbu-2">{judul_berita}</h1>
        <p className="penulis-detail-lbu">
        ...
        />
        <div
          className="isi-berita-lbu"
          dangerouslySetInnerHTML={{ __html: isi_berita }}></div>
      </div>
      <div className="komentar-lbu">
        <h1>Komentar</h1>
        <Row>
          {komentar.length === 0 ? (
            <Col xs={12}>
            ...
            currentComments.map((item, index) => (
              <Col
                ...
                <div className="komentar-dvk" dangerouslySetInnerHTML={{ __html: item.komentar }}></div>
              </Col>
            ))
          )}
        </Row>
      ...
      <div className="button-lbu-utama">
        <Button
          className="button-danger-lbu"
          type="danger"
          onClick={() => setShowHapusModal(true)}>
          Hapus
        </Button>
        <Button
          className="button-lbu"
          onClick={() => navigate("/detail-berita-user/" + id)}>
          Edit
        </Button>
      </div>
...
export default LihatBeritaUser;
