import "../css/user/tambah-berita-user.css";
...
function TambahBeritaUser() {
  ...
  const addBerita = async () => {
    ...
    try {
      ...
      if (response.ok) {
        localStorage.setItem("ta-berita-user", JSON.stringify(result));
  ...
  return (
    <Layout>
      <Promo />
      <div className="utama-tbu">
        <div className="kembali-tbu" onClick={() => navigate(-1)}>
          <svg
        ...
        <div
          className="tambah-gambar-berita-user"
          onClick={handleClick}
        ...
        <br></br>
        <Container>
          <div className="utama-judul-kategori-tbu">
            <Form.Group
              controlId="exampleForm.ControlInput1"
              className="form-one-tbu ">
          ...
          <div className="button-tbu">
            <Button
              onClick={addBerita}
              disabled={isLoading}
              className="button-tbu"
              style={{
...
export default TambahBeritaUser;
